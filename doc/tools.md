...
Every CLI block can install today: 45 tools across 17 blockchain systems, from
...
| [Starknet](#starknet) | 3 |
| [Stellar](#stellar) | 1 |
| [Zero-knowledge circuits](#zero-knowledge-circuits) | 1 |
| [ZKsync](#zksync) | 1 |
...
| `ethdo` | `ethdo` | Linux (x86-64, arm64), macOS (x86-64) | Command-line client for Ethereum consensus-layer accounts and validators |
...
| Tool | Commands | Platforms | What it is |
|:--|:--|:--|:--|
| `circom` | `circom` | Linux (x86-64), macOS (x86-64), Windows (x86-64) | Compiler for the circom zero-knowledge circuit language |
...
<!-- Generated by "make doc" from the recipes in registry/, vendored from
     block-registry at 5f753c063013aa80f91b3d223d88bfb2f4db1cb3. Do not edit by hand. -->
