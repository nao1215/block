...
Every CLI block can install today: 51 tools across 17 blockchain systems, from
...
| `ethereal` | `ethereal` | Linux (x86-64, arm64), macOS (x86-64) | Command-line tool for transactions, tokens and ENS on Ethereum |
...
| `heimdall` | `heimdall` | Linux (x86-64, arm64), macOS (x86-64, arm64) | EVM bytecode toolkit: disassemble, decompile and decode transactions |
...
| `nethermind` | `nethermind` | Linux (x86-64, arm64), macOS (x86-64, arm64), Windows (x86-64) | Ethereum execution client written in .NET |
...
<!-- Generated by "make doc" from the recipes in registry/, vendored from
     block-registry at df8fa5946e0042aba3cd401bc9cdad8c6f195562. Do not edit by hand. -->
