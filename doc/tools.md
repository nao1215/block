...
| `ethereal` | `ethereal` | Linux (x86-64, arm64), macOS (arm64) | Command-line tool for transactions, tokens and ENS on Ethereum |
...
| `heimdall` | `heimdall` | Linux (x86-64, arm64), macOS (arm64) | EVM bytecode toolkit: disassemble, decompile and decode transactions |
...
<!-- Generated by "make doc" from the recipes in registry/, vendored from
     block-registry at 961336aa4cc9987c8ecf2d2b6c520d15b8fdb9e7. Do not edit by hand. -->
